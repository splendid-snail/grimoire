...
low_rank_skills = ["inflame Men with womens Love, and women with mens love", "causeth great Battles and conflicts", "knoweth the virtues of Herbs and special Stones", "knoweth all the movements of the planets", "knoweth of wars and how the soldiers wille and shalle meet", "maketh men witty and bold","causeth wounds to putrefy that are made by Arrows and Archers", "reconcileth friends", "come to discover things hidden or lost", "fetcheth back runaways", "make you Eloquent and win arguments"]
mid_rank_skills = ["giveth honour and dignity to any", "transport men suddenly from one Country into another", "teach all Languages or Tongues presently", "destroy Dignities", "changeth the places of the dead", "cause the Spirits under him to gather together upon their Sepulchres", "giveth riches to a man", "restoreth lost dignity and honours", "maketh men cunning in all artes and sciences","knoweth hidden things and can discover Treasures", "maketh one witty in all manner of Ways"]
high_rank_skills = ["telleth of all things past and present", "sheweth ye the meaning of all questions you can ask", "cause Earthquakes", "giveth true answers to your Demands", "turn all mettals into Gold", "set Citties Castles and great Places on fire"]
...
demon_sigil_intros = ["His seale lookes like this:", "His sigil looks like this:", "His seale appeareth thus:", "This is his seal:", "This is his sigil:", "His sigil appeareth thus:", "This is his seale:"]
...
sacrifice_ritual_climax = ["As you enter a properly Magickal state, at last slay the ANIMAL with thy TOOL.", "At last, slay the ANIMAL with thy TOOL and let its blood flow over the altar.", "At last slay the ANIMAL with thy TOOL and let its blood runneth into a Cup.", "You know what must be done next. When the deed is done, thou art ready to consult the great DEMON_RANK DEMON_NAME.", "Kill now the ANIMAL with thy TOOL and in this last act of violence you shall have appeased the great DEMON_RANK DEMON_NAME.", "And the last Acte in pleasing the great DEMON_NAME is to kill the ANIMAL with thy TOOL."]
