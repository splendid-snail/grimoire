...
human_forms = ["nun", "prior", "abbot", "merchant", ""]
...
spirit_forms = ["angel","bugbear","centaur","chimera","cockatrice","cyclops","demon","djinn","dragon","draugr","dryad","dwarf","faun","gargoyle","genie","ghast","ghost","ghoul","giant","gnome","goblin","golem","gorgon","gremlin","griffon","hag","harpy","hippogriff","hobgoblin","homonculus","hydra","imp","incubus","kappa","kobold","kraken","lamassu","leprechaun","lich","manticore","mermaid","merman","minotaur","mummy","naga","nix","nymph","ogre","orc","pegasus","phoenix","poltergeist","roc","satyr","selkie","siren","spectre","sphinx","sprite","succubus","sylph","troll","vampire","valkyrie","warg","werewolf","wight","witch","wraith","wyvern"]
